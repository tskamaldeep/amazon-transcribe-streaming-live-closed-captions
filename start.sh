...
ffmpeg -loglevel quiet -re -i $input -vn -ac 1 -c:a pcm_s16le -ar 16000 -f wav - | node index.js --fifo=transcript_fifo --fifo-tr=transcript_fifo_fr --stdin=true >& out.log &
wait
